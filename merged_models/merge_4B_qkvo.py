...
base_save_root = "/dss/dssfs04/lwp-dss-0002/pn25ho/pn25ho-dss-0001/di93pux/multimodal/merged_models/merge_4B_only_qkvo/all"

#start_layers = list(range(17, 29))  # 19 ~ 28
start_layers=[21]
end_layer = 35
